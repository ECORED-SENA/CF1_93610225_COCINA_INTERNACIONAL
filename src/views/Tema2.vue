    ...
    #Herramientas_y_equipos_de_cocina_internacional.bg-full-width.bg-fondo-3
      .px-4.px-md-5.pb-md-3
        .row.justify-content-center.align-items-stretch.mb-5
          .col-md-6.col-lg-3.mb-4(data-aos="zoom-in-up")
          ...
          .col-md-6.col-lg-3.mb-4(data-aos="zoom-in-down")
            .rounded-top.rounded-bottom.custom-image-card.h-100
              ...
              .custom-image-card__text.p-4
                h5.mb-2.text-center Cuchara #[em Parisien]
        ...
        .row.justify-content-center.align-items-stretch.mb-5
          ...
          .col-md-6.col-lg-3.mb-4(data-aos="zoom-in-down")
            .rounded-top.rounded-bottom.custom-image-card.h-100
              ...
              .custom-image-card__text.p-4
                h5.mb-2.text-center Plato para #[em Escargots]
        ...
        .row.justify-content-center.align-items-stretch.mb-5
          ...
          .col-md-6.col-lg-3.mb-4(data-aos="zoom-in-down")
            .rounded-top.rounded-bottom.custom-image-card.h-100
              ...
              .custom-image-card__text.p-4
                h5.mb-2.text-center #[em Raclette]
          ...
          .col-md-6.col-lg-3.mb-4(data-aos="zoom-in-down")
            .rounded-top.rounded-bottom.custom-image-card.h-100
              ...
              .custom-image-card__text.p-4
                h5.mb-2.text-center Samovar para #[em Buffet]
